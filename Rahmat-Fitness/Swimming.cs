...
namespace Rahmat_Fitness
{
    public partial class Swimming : Form
    {
        ...
        {
            if (getTime.Text != "" && getWeight.Text != "" && getStorke.Text != "")
            {
                int lap;
                int stroke;
                int weight;
                ...
                bool valstroke = int.TryParse(getStorke.Text, out stroke);
        ...
        private void getStorke_TextChanged(object sender, EventArgs e)
        {
